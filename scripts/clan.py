...
class Clan():
    ...
    def post_initialization_functions(self):
        ...
        if self.medicine_cat is not None:
            ...
            if self.medicine_cat.status != 'medicine fox':
                Cat.all_cats[self.medicine_cat.ID].status_change('medicine fox')
    def create_clan(self):
        ...
        self.instructor = Cat(status=choice(["apprentice", "mediator apprentice", "medicine fox apprentice", "warrior",
                                             "medicine fox", "leader", "mediator", "queen", "queen's apprentice", "deputy", "elder"]),
                              )
        ...
        self.demon = Cat(status=choice(["apprentice", "mediator apprentice", "medicine fox apprentice", "warrior",
                                             "medicine fox", "leader", "mediator", "queen", "queen's apprentice", "deputy", "elder"]),
                              )
        self.demon.df = True
        ...
        for cat_id in Cat.all_cats:
            ...
            elif Cat.all_cats.get(cat_id).status == 'medicine fox apprentice':
                Cat.all_cats.get(cat_id).status_change('medicine fox apprentice')
    ...
    def new_medicine_cat(self, medicine_cat):
        ...
        """
        if medicine_cat:
            if medicine_cat.status != 'medicine fox':
                Cat.all_cats[medicine_cat.ID].status_change('medicine fox')
