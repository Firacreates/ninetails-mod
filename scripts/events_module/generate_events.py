...
class GenerateEvents:
    ...
    def filter_possible_short_events(possible_events, cat, other_cat, war, enemy_clan, other_clan, alive_kits, murder=False, murder_reveal=False):
        ...
        for event in possible_events:
            ...
            # check meddie tags
            if "medicine_fox" in event.tags and cat.status != "medicine fox":
                continue
            elif "medicine_cat_app" in event.tags and cat.status != "medicine fox apprentice":
                continue
            ...
            if other_cat:
                ...
                if "other_cat_dep" in event.tags and other_cat.status != "deputy":
                    continue
                if "other_cat_med" in event.tags and other_cat.status != "medicine fox":
                    continue
                if "other_cat_med_app" in event.tags and other_cat.status != "medicine fox apprentice":
                    continue
                ...
                if "other_cat_elder" in event.tags and other_cat.status != "elder":
                    continue
                if "other_cat_adult" in event.tags and other_cat.age in ["senior", "cub", "newborn"]:
                    continue
                if "other_cat_kit" in event.tags and other_cat.status not in ['newborn', 'cub']:
                    continue
...
"medicine_fox", "medicine_cat_app" < ensure that m_c is one of these ranks.  All other ranks are separated into their own .jsons
