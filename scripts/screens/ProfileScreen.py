...
class ProfileScreen(Screens):
    ...
    def build_profile(self):
        ...
        if is_sc_instructor:
            self.the_cat.thought = "Hello. I am here to guide the dead foxes of " + game.clan.name + "Clan into the heavens."
        if is_df_instructor:
            self.the_cat.thought = "Hello. I am here to drag the dead foxes of " + game.clan.name + "Clan into the dark."
    ...
    def get_apprenticeship_text(self):
        ...
        elif self.the_cat.status in ['apprentice', 'medicine fox apprentice', 'mediator apprentice']:
    ...
    def update_disabled_buttons_and_text(self):
        ...
        # Roles Tab
            ...
            if self.the_cat.status not in ['apprentice', 'medicine fox apprentice', 'mediator apprentice'] \
