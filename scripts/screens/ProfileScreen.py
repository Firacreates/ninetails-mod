...
class ProfileScreen(Screens):
                ...
                if b_data in b_2data:
                    ...
                    if cat.pelt.inventory:
                        for a, accessory in enumerate(new_inv[start_index:min(end_index, inventory_len + start_index)], start = start_index):
                            ...
                            elif accessory in cat.pelt.yokai_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(scale(pygame.Rect((200 + pos_x, 730 + pos_y), (100, 100))), sprites.sprites['acc_yokai' + accessory + cat_sprite], manager=MANAGER)
                            pos_x += 120
                            if pos_x >= 1100:
                                pos_x = 0
                                pos_y += 120
    ...
    def build_profile(self):
        ...
        if not (self.the_cat.dead or self.the_cat.outside) and (
                self.the_cat.status in ['medicine fox', 'medicine fox apprentice'] or
        ...
        elif self.the_cat.status in ["medicine fox", "medicine fox apprentice"] and self.the_cat.ID == game.clan.your_cat.ID:
    ...
    def get_apprenticeship_text(self):
        ...
        elif self.the_cat.status in ['apprentice', 'medicine fox apprentice', 'mediator apprentice', "queen's apprentice"]:
    ...
    def update_disabled_buttons_and_text(self):
        ...
        # Roles Tab
            ...
            if self.the_cat.status not in ['apprentice', 'medicine fox apprentice', 'mediator apprentice', "queen's apprentice"] \
            ...
            #                                      manager=MANAGER)
            if self.the_cat.status in ['leader', 'deputy', 'medicine fox', 'mediator', 'queen', 'warrior']:
