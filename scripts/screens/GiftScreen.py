...
class GiftScreen(Screens):
    ...
    def choose_discover_punishment(self, you, cat_to_murder, accomplice, accompliced):
        ...
        if punishment_chance == 1:
            if accomplice and not accompliced:
                ...
                you.shunned = 1
            txt = ""
            if game.clan.your_cat.status in ['cub', 'leader', 'deputy', 'medicine fox']:
        ...
        if punishment_chance == 1 or punishment_chance == 3:
            kit_punishment = ["You are assigned counseling by the Clan's medicine fox to help you understand the severity of your actions and to guide you to make better decisions in the future.",
                                "You are to be kept in the nursery under the watchful eye of the queens at all times until you become an apprentice."]
            gen_punishment = ["You are assigned counseling by the Clan's medicine fox to help you understand the severity of your actions and to guide you to make better decisions in the future.",
            ...
            # demote_medicine_cat = ["The Clan decides that you will be demoted to a warrior, no longer trusting you as their medicine fox."]
            # exiled = ["The Clan decides that they no longer feel safe with you as a Clanmate. You will be exiled from the Clan."]
            
            if you.status == 'cub' or you.status == 'newborn':
        ...
        if accomplice and accompliced and (punishment_chance == 2 or punishment_chance == 3):
            ...
            kit_punishment = [f"{a_n} is assigned counseling by the Clan's medicine fox to help them understand the severity of their actions and to guide them to make better decisions in the future.",
                            f"{a_n} is to be kept in the nursery under the watchful eye of the queens at all times until they become an apprentice."]
            gen_punishment = [f"{a_n} is assigned counseling by the Clan's medicine fox to help them understand the severity of their actions and to guide them to make better decisions in the future.",
            ...
            # demote_medicine_cat = [f"The Clan decides that {a_n} will be demoted to a warrior, no longer trusting them as their medicine fox."]
            # exiled = [f"The Clan decides that they no longer feel safe with {a_n} as a Clanmate. They will be exiled from the Clan."]

            if accomplice.status == 'cub' or accomplice.status == 'newborn':
                game.cur_events_list.insert(3, Single_Event(choice(kit_punishment)))
            ...
            elif accomplice.status == 'medicine fox':
                lead_choice = randint(1,3)
                if lead_choice == 1:
                    game.cur_events_list.insert(3, Single_Event(choice(gen_punishment)))
    ...
    def get_discover_chance(self, you, cat_to_murder, accomplice=None, accompliced=None):
        ...
        if you.experience >= 100:
            ...
            chance += 20
        if cat_to_murder.status in ['leader', 'deputy', 'medicine fox']:
            chance += 20
        if you.status in ['leader', 'deputy', 'medicine fox']:
            chance -= 10
        if accomplice and accompliced:
            chance -= 10
    ...
    def get_accomplice_chance(self, you, accomplice):
        ...
        if accomplice.relationships[you.ID].admiration > 10:
            chance += 10
        if you.status in ['medicine fox', 'mediator', 'deputy', 'leader']:
            chance += 10
        if accomplice.status in ['medicine fox', 'mediator', 'deputy', 'leader']:
            chance -= 20
