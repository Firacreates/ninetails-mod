...
class TalkScreen(Screens):
    ...
    def load_texts(self, cat):
        ...
        if cat.status in ["rogue", "loner", "kittypet"]:
            ...
            if cat.status not in ['cub', "newborn"] and you.status not in ['cub', 'newborn']:
            ...
            if cat.status not in ['cub', "newborn"] and you.status in ['cub', 'newborn']:
            ...
            if cat.status not in ['cub', 'newborn'] and you.status not in ['cub', 'newborn'] and randint(1,3)==1:
    ...
    def filter_texts(self, cat, possible_texts):
        ...
        for talk_key, talk in possible_texts.items():
            ...
            if you.status not in tags and "any" not in tags and "young elder" not in tags and "no_kit" not in tags and "you_any" not in tags:
                ...
                continue
            elif "no_kit" in tags and (you.status in ['cub', 'newborn'] or cat.status in ['cub', 'newborn']):
                continue
            elif "newborn" in tags and "cub" not in tags and you.moons != 0:
                continue

            if "they_adult" in tags and cat.status in ['apprentice', 'medicine fox apprentice', 'mediator apprentice', "queen's apprentice", "cub", "newborn"]:
                continue

            if "you_adult" in tags and you.status in ['apprentice', 'medicine fox apprentice', 'mediator apprentice', "queen's apprentice", "cub", "newborn"]:
                continue

            if "they_app" in tags and cat.status not in ['apprentice', 'medicine fox apprentice', 'mediator apprentice', "queen's apprentice"]:
                continue
            ...
            roles = ["you_cub", "you_apprentice", "you_medicine_cat_apprentice", "you_mediator_apprentice", "you_queen's_apprentice", "you_warrior", "you_mediator", "you_medicine_cat", "you_queen", "you_deputy", "you_leader", "you_elder", "you_newborn"]
            if any(r in roles for r in tags):
                has_role = False
                if "you_cub" in tags and you.status == "cub":
                    has_role = True
                elif "you_apprentice" in tags and you.status == "apprentice":
                    has_role = True
                elif "you_medicine_cat_apprentice" in tags and you.status == "medicine fox apprentice":
                    has_role = True
                    ...
                    has_role = True
                elif "you_medicine_cat" in tags and you.status == "medicine fox":
                    has_role = True
            ...
            roles = ["they_cub", "they_apprentice", "they_medicine_cat_apprentice", "they_mediator_apprentice", "they_queen's_apprentice", "they_warrior", "they_mediator", "they_medicine_cat", "they_queen", "they_deputy", "they_leader", "they_elder", "they_newborn"]
            if any(r in roles for r in tags):
                has_role = False
                if "they_cub" in tags and cat.status == "cub":
                    has_role = True
                elif "they_apprentice" in tags and cat.status == "apprentice":
                    has_role = True
                elif "they_medicine_cat_apprentice" in tags and cat.status == "medicine fox apprentice":
                    has_role = True
                    ...
                    has_role = True
                elif "they_medicine_cat" in tags and cat.status == "medicine fox":
                    has_role = True
            ...
            if "clan_has_kits" in tags:
                ...
                for c in Cat.all_cats_list:
                    if c.status == "cub" and not c.dead and not c.outside:
                        clan_has_kits = True
    ...
    def adjust_txt(self, text, cat):
        ...
        try:
            ...
            # Random medicine fox or medicine fox apprentice
            if "r_m" in text:
                cluster = False
                rel = False
