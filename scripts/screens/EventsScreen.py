    ...
    def handle_event(self, event):
        ...
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            if event.ui_element == self.timeskip_button and game.clan.your_cat.dead_for >= 1 and not game.switches['continue_after_death']:
                ...
                DeathScreen('events screen')
                return
            if event.ui_element == self.timeskip_button and game.clan.your_cat.moons == 5 and game.clan.your_cat.status == 'cub' and not game.clan.your_cat.outside and not game.clan.your_cat.dead:
            ...
            if event.key == pygame.K_RIGHT:
                ...
                if game.clan.your_cat.moons == 5 and game.clan.your_cat.status == 'cub' and not game.clan.your_cat.outside and not game.clan.your_cat.dead:
                    PickPath('events screen')
