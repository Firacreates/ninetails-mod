...
class MakeClanScreen(Screens):
    ...
    def create_example_cats2(self):
        ...
        for a in range(c_size):
            ...
            if self.clan_age == "new":
                if game.choose_cats[a].status not in ['newborn', 'cub']:
                ...
                if random.randint(1,5) == 1 and game.choose_cats[a].status not in ['newborn', 'cub']:
                    game.choose_cats[a].backstory = choice(backstories)
                else:
                    game.choose_cats[a].backstory = 'clanborn'
    ...
    def randomize_custom_cat(self):
        ...
        self.cub_sprite=random.randint(0,2)
    ...
    # values are ((x position, y position), (x width, y height))
        ...
        self.elements['preview age'] = pygame_gui.elements.UIDropDownMenu(["cub", "adolescent", "adult", "elder"], str(self.preview_age), scale(pygame.Rect((x_align, y_pos[6]), (260, 70))), manager=MANAGER)
        c_moons = 1
        ...
        self.elements['pose'] = pygame_gui.elements.UIDropDownMenu(["0", "1", "2"], str(self.cub_sprite), scale(pygame.Rect((column1_x, y_pos[8]), (250, 70))), manager=MANAGER)
        ...
        if event.type == pygame_gui.UI_DROP_DOWN_MENU_CHANGED:
            ...
            if self.page == 0:
                ...
                if event.ui_element == self.elements['pelt length']:
                    ...
                    self.cub_sprite = int(event.text)
                    self.update_sprite()
