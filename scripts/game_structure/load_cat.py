    ...
    for i, cat in enumerate(cat_data):
        try:
            ...
            new_cat.pelt = Pelt(
                ...
                cub_sprite=cat["sprite_cub"] if "sprite_cub" in cat else cat["spirit_cub"],
            ...
            if "facets" in cat:
                ...
                new_cat.personality = Personality(trait=cat["trait"], kit_trait=new_cat.age in ["newborn", "cub"],
            ...
            if i.strip() != '':
                ...
                game.switches[
                    'error_message'] = '4There was an error loading cat # ' + str(
                        attr[0])
                the_cat.pelt.cat_sprites['cub'], the_cat.pelt.cat_sprites[
