...
class Cat():
    ...
    def __init__(self,
        ...
        if status is None and moons is None:
            ...
            if status == 'newborn':
                ...
                self.age = 'senior'
            elif status in ['apprentice', 'mediator apprentice', 'medicine fox apprentice']:
                self.age = 'adolescent'
            else:
    ...
    def rank_change_traits_skill(self, mentor):
        ...
        if self.status in ["warrior", "medicine fox", "mediator"]:
    ...
    def one_moon(self):
        ...
        if self.status in ['apprentice', 'mediator apprentice', 'medicine fox apprentice']:
            self.update_mentor()
    ...
    def get_ill(self, name, event_triggered=False, lethal=True, severity='default'):
        ...
        if name not in ILLNESSES:
            ...
            return
        if name == 'kittencough' and self.status != 'cub':
            return
    ...
    def retire_cat(self):
        ...
        if self.moons > 6 and self.status in ["apprentice", "medicine fox apprentice", "mediator apprentice"]:
    ...
    for a in range(12):
        if a in e:
            ...
            game.choose_cats[a] = Cat(status=choice(
                ['cub', 'apprentice', 'warrior', 'warrior', 'elder']), biome=None)
