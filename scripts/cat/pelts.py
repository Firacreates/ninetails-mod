...
class Pelt():
    ...
    def __init__(self,
        ...
        self.cat_sprites =  {
            "cub": cub_sprite if cub_sprite is not None else 0,
    ...
    def describe_appearance(cat, short=False):
        ...
        if cat.genderalign in ["female", "trans female"]:
            color_name = f"{color_name} vixen"
        elif cat.genderalign in ["male", "trans male"]:
            color_name = f"{color_name} tod"
        else:
            color_name = f"{color_name} fox"
